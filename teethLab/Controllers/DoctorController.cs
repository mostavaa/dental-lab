...
//                    {
//                        Response.Write(price.CurrentCas.name + "," + price.price + "," + price.id + "^");
//                    }
//                }
//            }
...
//            List<CurrentCas> allcases = dm.getallcases();
//            if (allcases != null && allcases.Count > 0)
//            {
//                foreach (CurrentCas cs in allcases)
//                {
...
//            return null;
//        }
//        public List<CurrentCas> getallcases()
//        {
